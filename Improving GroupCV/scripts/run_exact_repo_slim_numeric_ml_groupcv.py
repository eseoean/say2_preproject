#!/usr/bin/env python3
"""
Run GroupCV for ML models on the exact-slim numeric-only matrix.
"""
...
def main() -> None:
    ...
    parser.add_argument("--output-stem", default="exact_repo_slim_numeric_ml_groupcv_v1")
    ...
    results = {
        ...
        "input_keys_path": str(DATA_ROOT / "features_slim_exact_repo.parquet"),
    ...
    for model_name in model_names:
        print("=" * 72)
        print(f"[{model_name}] exact slim numeric-only")
        print("=" * 72)
        fold_rows = []
        t0 = time.time()
