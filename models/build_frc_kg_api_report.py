#!/usr/bin/env python3
"""
Build an HTML/CSV summary report from FRC KG/API collection outputs.
"""
...
KG_DIR = BASE_DIR / "kg_api_results_frc_strong_context_smiles"
...
def main() -> None:
    ...
    if not summary_csv.exists() or not results_json.exists():
        raise SystemExit("KG/API result files not found. Run collect_frc_kg_api_data.py first.")
...
<head>
  <meta charset="utf-8">
  <title>FRC KG/API Summary</title>
  <style>
...
<body>
  <h1>FRC Ensemble KG/API Summary</h1>
  <div class="meta">
